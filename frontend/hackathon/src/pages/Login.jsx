      ...
      <div className="relative w-full max-w-md lg:max-w-7xl">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start">
          ...
          <div className="lg:animate-slideInRight lg:min-h-[800px] lg:flex lg:flex-col lg:justify-center">
            ...
            {isLoading && (
              <div className="fixed md:absolute bottom-4 md:bottom-auto md:top-4 right-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-lg shadow-lg animate-slideInRight flex items-center gap-2">
                <CheckCircle size={16} />
